...
// spred operator
let numbersds: number[] = [2, 4, 6, 8, 9];
let numbersdsp: number[] = [2, 4, 6, 8, 9];
let newcopyarray: number[] = [...numbersds, ...numbersdsp];
...
// rest operator
let numbersdr: number[] = [2, 4, 6, 8, 9];
...
function some(value: number | string) {
  console.log(value);
}
some(10);
